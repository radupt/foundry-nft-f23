...
contract MoodNftTest is Test {
    ...
    function testViewTokenURI() public {
        vm.prank(USER);
        moodNft.mintNft(); // we need a user because we're actually minting it to this test contract, and in don't have a receive function. open zeppelin have some code that
        //people wouldn't accidentally send nft's to contracts that can't tranfesr them or do anything with them
